            ...
            <div class="viewheader">
                ...
                <div class="meta">
                    ...
                    <div class="archive-links">
                        <span class="icon">&#xf088;</span> If there's a paywall, perhaps you can get around it via <a href="https://removepaywalls.com/<?= $article["url"] ?>">removepaywalls.com</a>, <a href="https://archive.today/submit/?url=<?= rawurlencode($article["url"]) ?>">archive.today</a>, or <a href="https://web.archive.org/web/9999/<?= $article["url"] ?>">archive.org</a>.
                    </div>
