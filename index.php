                ...
                <?php foreach ($articles as $article) { ?>
                    <tr>
                        ...
                        <td class="middle">
                            ...
                            <span class="info">- <abbr title="Estimated reading time">ERT</abbr>: <abbr title="<?= $article["wordcount"] ?> words"><?= Helper::makeTimeHumanReadable(TextExtractor::computeErt($article["wordcount"]), true) ?></abbr></span>
                        </td>
                        <td class="actions">
